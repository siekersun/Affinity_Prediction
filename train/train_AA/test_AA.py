...
data_test['Predict'] = pred.detach().cpu().numpy()
data_test.to_csv('train_AA/Predict/iGB3_external_pred.csv', index=False)
print("Predictions saved to train_AA/Predict/iGB3_external_pred.csv")
